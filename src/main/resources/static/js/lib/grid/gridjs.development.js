(function (global, factory) {
	...
	***************************************************************************** */
	...
	var n,l,u,i,t,r,o,f={},e=[],c=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;function s(n,l){for(var u in l)n[u]=l[u];return n}function a(n){var l=n.parentNode;l&&l.removeChild(n);}
	function v(n,l,u){
		var i,t=arguments,r={};
	...
	var enUS = {
		...
		pagination: {
			previous: '이전',
			next: '다음',
			navigate: function (page, pages) { return page + " ~ " + pages + ' 페이지'; },
			page: function (page) { return page + " 페이지"; },
			showing: '총',
			of: '번째',
			to: '~',
			results: '개 중',
